#!/bin/bash
# Completion of a eh array, established per task from sacct -- never from squeue -u, whose output spans every
# project submitting under this user.    bash verify.sh {probe_e5|prod_e5|probe_e3|prod_e3}
