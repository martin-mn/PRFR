#!/usr/bin/env python3
"""
SI Figure 3: the share of the population in each atom -- efficient, stable, competitive -- on the disk of games, and
the most abundant atom at each game, for the 65536 binary memory-two strategies in the two Wright-Fisher runs:
N = 100, beta = 3, mu = 1e-4 (rows 1-2, panels a-h; data/runs/m2_N100.csv) and N = 1000, beta = 100, mu = 1e-2
(rows 3-4, panels i-p; data/runs/m2_N1000.csv), eps = 1e-4 in both.

    python3 sifig3.py            ->  SIFig3.pdf / SIFig3.png  (here)
...
draw_runs() is the original FinalFigures/atomshares.draw_runs(), shared there by SI Figures 2 and 3 (SIFigure2/sifig2.py
...
if __name__ == "__main__":
    draw_runs([("m2", "F2"), ("m2", "F1")], os.path.join(HERE, "SIFig3.pdf"), ["Memory-2, $N = 100$", "Memory-2, $N = 1000$"])
